...
public class mess extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try 
		{
			...
			PreparedStatement pstmt=con.prepareStatement("insert into message(Position,Name, Message) values(?,?,?)");
			...
			RequestDispatcher dispatcher=request.getRequestDispatcher("StuProf.jsp");
