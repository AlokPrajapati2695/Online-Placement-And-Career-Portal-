...
<table align="center">
<tr>
<td style="font-size: large; color: blue; font-family: cambria;"><a href="comhome.jsp"> Home</a>  </td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

<td style="font-size: large; color: blue; font-family: cambria;"><a href="CompMessage.jsp"> Message</a> </td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

<td style="font-size: large; color: blue; font-family: cambria;"><a href="NtCompReport.jsp">Notice</a> </td>

</tr>
</table>
<hr size="1" color="red"><br/>

<form name="message1" method="post" action="MessComp" onsubmit="return validation()">
