...
function validation()
{  
	var name=document.NOTCompany.message.value;  
...
<form name="NOTCompany" method="post" action="NoteComp" onsubmit="return validation()">
...
<u><b>Write the Notice for Company:</b></u><br/><br/></td>
<td>
